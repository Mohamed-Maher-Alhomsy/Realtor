        ...
        <div className="flex flex-col w-full">
          ...
          <div className="mt-3 mb-6">
            <textarea
              ...
              className="w-full px-4 py-2 tetx-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600"
            ></textarea>
          </div>
